...
const HotelBanner = () => {
  ...
  return <div className="relative bg-[url('/images/hotel-bg.jpg')] bg-center bg-no-repeat bg-cover bg-blend-darken py-[100px] text-center">
    <div className="container">
      ...
      <h1 className="my-[40px] text-4xl font-semibold text-white">Find the right <span className="text-green-600">hotel today</span></h1>
          ...
          <div className="grid grid-cols-12">
            <div className="xl:col-span-10 lg:col-span-12 xs:col-span-12 col-span-12 grid grid-cols-12">
              ...
              <div className="destinations col-span-12 xl:col-span-5">
                <label className="text-white flex justify-start mb-2 font-semibold">Where do you want to stay?</label>
              ...
              <div className="Check_in col-span-12 xs:mt-0 xl:col-span-2">
                <label className="text-white flex justify-start mb-2 font-semibold">Check in</label>
                <DatePicker
                  selected={startDate}
              ...
              <div className="sel_booking col-span-12 xs:mt-0 xl:col-span-3">
                <label className="text-white flex justify-start mb-2 font-semibold">Guests and rooms</label>
