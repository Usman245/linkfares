...
const HotelSwiperCard = () => {
  return (
    <div className="flex flex-col">
      <div className="h-[180px] rounded-t-xl relative">
        <img security="hotelavani.png" className="object-fill rounded-t-xl" />

        <div className="flex flex-col gap-2 absolute left-[20px] bottom-[20px]">
          <ReactStars
            count={5}
