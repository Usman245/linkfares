      ...
      <div className='flex flex-col {isVisible ? "show" : ""}'>
        <div className="flex flex-col gap-8">
            ...
            {HoterFilter.AccomoDation?.map((items, index) => (
              <div key={index} className="flex justify-between items-center">
                <div className="flex  items-center gap-1">
                  ...
                  <p className="text-xs font-regular text-black-16">{items.tagTitle}</p>
                </div>
            ...
            {HoterFilter.GuestRating?.map((items, index) => (
              <div key={index} className="flex justify-between items-center">
                <div className="flex  items-center gap-1">
                  ...
                  <p className="text-xs font-regular text-black-16 flex items-center gap-2"><span className="font-bold">{items.rates}+</span>{items.tagTitle}</p>
                </div>
                <p className="text-xs font-regular text-gray-2B">{items.tagCount}</p>
              </div>
            ))}
          ...
          <div className="flex flex-col gap-3">
            ...
            <button onClick={() => setTagShowAll(tagShowAll === 3 ? HoterFilter.Amerities.length : 3)} className="text-blue-400 flex justify-start">
          ...
          <diV className="flex flex-col gap-3">
            ...
            {HoterFilter.MealPlan.slice(0, tagShowAllSingle)?.map((items, index) => (
              <div className="flex justify-between items-center">
                <div className="flex  items-center gap-1">
                  <div>
            ...
            <button onClick={() => setTagShowAllSingle(tagShowAllSingle === 1 ? HoterFilter.Amerities.length : 1)} className="text-blue-400 flex justify-start">
