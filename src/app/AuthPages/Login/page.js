  ...
  return (
    <div className="flex min-h-screen font-poppins">
      ...
      <div className="w-full lg:w-1/2 bg-white flex flex-col justify-center py-16 px-8 lg:px-20">
        ...
        <p className="text-sm font-medium mt-1 mb-8">Enter your Credentials to access your account</p>
        ...
        <form className="space-y-6">
          ...
          <div>
            <label className="block text-black font-medium mt-4">Password</label>
            <input
              type="password"
      ...
      <label htmlFor="customCheckbox" className="ml-2 font-medium text-sm cursor-pointer">
        ...
        <p className="text-center font-medium">
          Do not have an account? <Link href="/AuthPages/Signup" className="text-green-600 font-semibold">Sign Up</Link>
        </p>
      </div>
